      ...
      <b-card-body>
        ...
        <div v-else>
          <p class="mt-0 mb-1">
            ...
            <span v-if="this.form.inicio_rolagem !== ''">{{ this.form.evento.inicio_rolagem | moment }}</span> -
            <span v-if="this.form.fim_rolagem !== ''">{{ this.form.evento.fim_rolagem | moment}}</span>
          </p>
          <p class="mt-0 mb-1">
