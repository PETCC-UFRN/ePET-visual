  ...
  <div>
    <div class="card">
      <div class="card-header">
        <b-row>
          <b-col>
            <h2><i class="fa fa-edit px-2"></i>Cadastrar disciplina</h2>
          </b-col>
        </b-row>
      </div>
      <div class="card-body">
            ...
            <b-row>
              <b-col cols="4">
                <div class="form-group">
                  ...
                  <the-mask id="codigo" :mask="['AAA####']" class="form-control" placeholder="Digite o código" v-model="form.codigo" required />
              ...
              <b-col>
                <div class="form-group">
                  ...
                  <input  id="nome" type="text" class="form-control" placeholder="Digite o nome" v-model="form.nome" />
                </div>
              </b-col>
            </b-row>
          <div class="form-group">
            <b-button block type="submit" variant="success"><i class="fa fa-check fa-fw"></i> Confirmar cadastro de disciplina</b-button>
          </div>
        </form>
      </div>
    </div>
      ...
      <div v-else>
        <div v-if="disciplinas.length > 0">
          <b-input-group  class="mt-3 mb-3" >
            <b-form-input
              v-model="keyword"
              placeholder="Buscar por nome ou por código"            
              type="text"
            ></b-form-input>
