<template>
  <div class="container pt-5">
    <br>
    <h1 class="mt-3 mb-0"><nuxt-link to="/eventos/abertos"> <i class="fa fa-chevron-circle-left" aria-hidden="true"></i>
 Voltar aos eventos abertos</nuxt-link></h1>
      <hr>
    <b-row>
			<b-col>
				<b-img v-if="this.evento.imagem !== null" rounded center class="mt-3 mb-5" v-bind="mainProps" :src="`https://petcc.dimap.ufrn.br:8443/downloadfile/${imageData}`" fluid alt="Imagem do evento"></b-img>
				<h3>{{evento.titulo}}</h3>
				<p class="mt-4 mb-1">
