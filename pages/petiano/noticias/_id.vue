    ...
    <b-card>
      ...
      <b-card-body>
        ...
        <div v-else>
          ...
          <b-img v-if="form.imagem !== null" center class="mt-3 mb-5" v-bind="mainProps" :src="`https://petcc.dimap.ufrn.br:8443/downloadfile/${imageData}`" fluid alt="Responsive image"></b-img>
