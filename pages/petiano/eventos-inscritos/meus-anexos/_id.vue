...
export default {
  ...
  methods: {
    ...
    fazerUploadAnexo(evento) {
      ...
      this.$axios
        .post(`anexos-participante-upload/${this.$route.params.id}`, formData, {
        ...
        .then(res => {
          ...
          this.$axios
            .post(`anexos-participante-cadastro/${this.$route.params.id}`, {
    ...
    removeAnexo(idAnexo) {
      this.$axios
        .delete(`anexos-participantes-remove/${idAnexo}`)
        .then(res => {
          Swal.fire({
