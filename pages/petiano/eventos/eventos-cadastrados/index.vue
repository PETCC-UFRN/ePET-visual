      ...
      <div v-if="eventos.length > 0">
        ...
        <b-input-group class="mt-3 mb-3">
          ...
          <b-input-group-text slot="append">
            <b-btn class="p-0" :disabled="!keyword" variant="link" size="sm" @click="keyword = ''"><i
    ...
    data() {
      return {
        ...
        fields: [
          ...
          {
            key: "d_inscricao", sortable: true, label: "Início das inscrições", formatter: (value) => {
              if (value != null) return moment(value).format('DD/MM/Y')
            }
          },
          {
            key: "d_inscricao_fim", sortable: true, label: "Fim das inscrições", formatter: (value) => {
              if (value != null) return moment(value).format('DD/MM/Y')
            }
          },
