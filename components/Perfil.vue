...
export default {
  name: "perfil",
    data() {
        return {
            currentPhoto: "https://images.pexels.com/photos/69954/lemur-madagascar-monkey-animal-world-69954.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260",
            plus: "~/assets/plus.png"
        };
    },

  methods: {
    preChangePhoto: function() {
        currentPhoto = plus;
        //currentPhoto: "https://images.pexels.com/photos/69954/lemur-madagascar-monkey-animal-world-69954.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260"
    }
  },
